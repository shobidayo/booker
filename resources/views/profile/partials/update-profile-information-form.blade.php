<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="tell_number" name="tell_number" type="text" class="mt-1 block w-full" :value="old('tell_number', $user->tell_number)" required autofocus autocomplete="tell_number" />
            <x-input-error class="mt-2" :messages="$errors->get('tell_number')" />
        </div>
